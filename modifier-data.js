...
export const PARTS = [
  {
    ...
    options: [
      ...
      { id: "black", name: "Black", emoji: "⚫", hex: "#111316", fact: "Black like a panther sneaking through the night!" },
      { id: "obsidian", name: "Obsidian", emoji: "⚫", hex: "#222633", fact: "Obsidian is dark volcanic glass made when lava cools quickly!" },
      { id: "charcoal", name: "Charcoal", emoji: "⚫", hex: "#34383c", fact: "Charcoal grey like a pencil sketch of your favourite car!" },
      { id: "graphite", name: "Graphite", emoji: "⚫", hex: "#535a60", fact: "Graphite is the grey mineral that makes a pencil's marks!" },
      { id: "grey", name: "Grey", emoji: "⚪", hex: "#80868b", fact: "Grey like an elephant with big flapping ears!" },
      { id: "silver", name: "Silver", emoji: "⚪", hex: "#b9c0c6", fact: "Silver like a knight's suit of armour! Ready for adventure!" },
      { id: "forest-green", name: "Forest green", emoji: "🟢", hex: "#1f5135", fact: "Deep green like tall pine trees in a peaceful forest!" },
      { id: "olive", name: "Olive", emoji: "🟢", hex: "#626b36", fact: "Olive green like little olives growing on a sunny hillside!" },
      { id: "sage", name: "Sage", emoji: "🟢", hex: "#91a582", fact: "Sage is a herb with soft grey-green leaves!" },
      { id: "mint", name: "Mint", emoji: "🟢", hex: "#84d5b1", fact: "Mint green like a scoop of mint ice cream! Delicious!" },
      { id: "teal", name: "Teal", emoji: "🔵", hex: "#168b8a", fact: "Teal mixes blue and green, like a sparkling tropical lagoon!" },
      { id: "navy", name: "Navy", emoji: "🔵", hex: "#182d58", fact: "Navy blue like the sky just before the stars come out!" },
      { id: "sky-blue", name: "Sky blue", emoji: "🔵", hex: "#73bce8", fact: "Sky blue like a bright summer day! Look up at the clouds!" },
      { id: "burgundy", name: "Burgundy", emoji: "🔴", hex: "#721c37", fact: "Burgundy is a deep red, like ripe cherries in a basket!" },
      { id: "bronze", name: "Bronze", emoji: "🟠", hex: "#a87542", fact: "Bronze like a medal on the racing podium! Well done!" },
      { id: "cream", name: "Cream", emoji: "⚪", hex: "#efe1bc", fact: "Cream like a swirl of vanilla ice cream! What a treat!" },
    ],
  },
  {
    id: "wheels",
  ...
  },
  {
    ...
    options: [
      { id: "four", name: "4-cylinder", emoji: "🔵", fact: "Count the cylinders: 1, 2, 3, 4!", effects: {} },
      {
        ...
        effects: { top: 1.5, accel: 1.7, offroadTop: 1.2 },
      },
      {
        id: "eight",
        name: "V8",
        ...
        effects: { top: 2, accel: 2.4, offroadTop: 1.4 },
      },
      {
        id: "electric",
        name: "Electric motor",
        ...
        effects: { accel: 3.2, top: 1.7, offroadTop: 1.3 },
      },
    ],
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { id: "small", name: "Twin side boosters", emoji: "🚀", fact: "Two side-mounted rockets for a quick boost! Whoosh!", effects: {} },
      {
        ...
        name: "Big booster",
        emoji: "☄️",
        fact: "Bigger rocket = harder launch, more speed and longer boost! Hang on!",
        effects: { boostTime: 1.8, boostTop: 1.25 },
      },
    ],
  },
];
